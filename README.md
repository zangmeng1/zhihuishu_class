    ...
    标准格式：
      {
         "账号1": {
           "password": "密码",
           "class_name": "",//填写要刷的课程名称，若当前进行的课程只有一个，则可以不填写
           "watch_time": 28 //观看视频时长，建议大于自己课程的建议观看时长3~4分钟
           "watch_live": 1 //是否刷见面课，1开0关。开启自动检测课程已结束见面课直播并观看。（检测会浪费时间，没有见面课不要开）
            },
         "账号2": {
           "password": "密码",
           "class_name": "开心学日语|长白山文化",//若账号有多个进行中课程，则可用`|`分割，课程名称可只写关键字
           "watch_time": 28
           "watch_live": 0
            }
      }
